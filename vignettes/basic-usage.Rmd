...
### Bilateral trade at community level (Year - Reporter - Partner - Section Code)
...
`yrpc-sa` table returns some fields that deserve an explanation which can be seen at [docs.tradestatistics.io](docs.tradestatistics.io).
...
This table accepts different years, reporters and partners just like `yrpc-sa`.
...
This table accepts different years, reporters and product codes just like `yrpc-sa`.
