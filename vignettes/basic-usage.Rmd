...
`g` and `s` are aggregations over `c`, therefore `yrpc-sa` (`yrpc` with section aggregation) and `yrpc-ga` (`yrpc` with group aggregation) are summaries of `yrpc`.
