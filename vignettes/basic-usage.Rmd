...
If we want Chilean trade at commodity level in 2019 with respect to commodity "010110" which means "Horses, asses, mules and hinnies; live, pure-bred breeding animals":
```{r yrc2, eval = T}
...
If we want the traded values of the commodity "010110" which means "Horses, asses, mules and hinnies; live, pure-bred breeding animals" in 2019:
```{r yc2, eval = T}
